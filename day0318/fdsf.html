			...
			<div id="header_wrap" class=" fixed-top">
				<div class="header_container ">
					...
					<c:if test="${sessionScope.kakaoN!=null}">
						<span class="loginBtn"> <b>${sessionScope.kakaoN}(${sessionScope.kakaoE})님</b> &nbsp; &nbsp;<a href="https://kauth.kakao.com/oauth/logout?client_id=1ae5e64fdf23e2e6840b736262379606&logout_redirect_uri=http://localhost:9005/kakaologout" onclick="logouts()">Logout</a>
